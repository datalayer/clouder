...
| --- | --- | --- |
| What it mounts | Home folders, datasets, NFS exports, Git checkouts, buckets — including a folder on a user's own computer, through the bridge relay | Once: a folder on a user's own computer (that delivery is now a gateway grant) |
