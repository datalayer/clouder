...
The inventory is 18 Core plus 7 AI plus 8 Runtimes collections, 33 in total.
...
#   3) All        - All collections (33 collections)
...
| File | Scope | CR Name |
|------|-------|---------|
| `datalayer-backup-s3.yaml` | All 33 collections | `datalayer-solr-collection-backups` |
