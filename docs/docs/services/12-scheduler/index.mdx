...
- `GET /api/scheduler/v1/schedules/{id}/runs`
- `GET /api/scheduler/v1/schedules/runs`
- `POST /api/scheduler/v1/schedules` (upsert: creating a schedule for a target that already has one replaces it)
- `PUT /api/scheduler/v1/schedules/{id}`
