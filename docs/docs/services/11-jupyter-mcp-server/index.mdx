...
:::
| Organization usage | `GET /api/mcp/v1/organizations/{uid}/usage` | The same roles as the overview. Spend, running sandboxes and the per-minute cap, each beside the limit in force — see [The two sandbox quotas](#the-two-sandbox-quotas) |
