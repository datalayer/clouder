...
spec:
  contents:
    ...
    - uid: 01M0YX0MXYRP0Q29YWYRE5THZE # jakevdp-sklearn-tutorial-content
      mount: /home/datalayer/tutorials/sklearn-tutorial
```
...
:::warning An `environment-build` reservation needs the same exemption, found live 2026-09-14
A build's own IAM reservation (E1-13) also has no pod for as long as it runs —
