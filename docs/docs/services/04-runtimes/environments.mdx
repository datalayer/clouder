...
- **Not built yet:** the builder itself, the registry it pushes to, scanning and signing. Until they land, a build reaches the step that needs them and is refused with `DL_ENV_CAPABILITY_UNSUPPORTED`, naming what is missing.
