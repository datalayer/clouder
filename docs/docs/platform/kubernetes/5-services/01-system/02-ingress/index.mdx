...
Instead of Traefik, you may deploy Nginx (watch out for potential latency for the creation of the Ingress Kubernetes objects, impacting the [Datalayer Jupyter](/platform/kubernetes/services/jupyter) service).
