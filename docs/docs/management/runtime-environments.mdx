...
Restarting `datalayer-buildkit` kills the build it is running. [BuildKit](/services/system/buildkit/#restarting-it-safely) gives the check for builds in flight to run first.
